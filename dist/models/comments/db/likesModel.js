...
exports.commentSchema.methods.addLike =
    function (userId, likeStatus) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!myStatus) {
                likes.push(newLike);
                this.commentSchema.likesCount = likes.filter(i => i.likesStatus === comment_db_model_1.likesStatuses.like).length;
                this.commentSchema.dislikesCount = likes.filter(i => i.likesStatus === comment_db_model_1.likesStatuses.dislike).length;
